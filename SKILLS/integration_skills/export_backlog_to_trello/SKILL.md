# Skill: export_backlog_to_trello/SKILL

## Purpose

Export AppForge backlog/epics/stories/tasks to Trello via manual packet or API/execution packet. Source of truth remains project-control.
