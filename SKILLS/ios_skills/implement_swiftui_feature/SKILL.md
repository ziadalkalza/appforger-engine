# Implement SwiftUI Feature
    ...
    ## Purpose
    Create a Codex task for implementing a SwiftUI feature from approved design and API contracts.
...
- Test checklist
    ...
    - `NATIVE_IOS/swiftui_rules.md`
- `NATIVE_IOS/ios_architecture.md`
