# Implement Compose Feature
    ...
    ## Purpose
    Create a Codex task for implementing a Kotlin Jetpack Compose feature from approved design and API contracts.
...
- Test checklist
    ...
    - `NATIVE_ANDROID/compose_rules.md`
- `NATIVE_ANDROID/android_architecture.md`
- `HANDOFFS/figma_to_codex.md`
