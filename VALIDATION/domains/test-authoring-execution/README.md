...
This layer defines how AppForge creates, evolves, writes, runs, and records tests. It complements `validation/domains/qa/` and `workflows/operations/task-completion-evidence/`.
