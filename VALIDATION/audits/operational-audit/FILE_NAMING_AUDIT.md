...
- `templates/specs/feature_spec_template.md`
- `templates/specs/api_contract_template.md`
- `templates/specs/screen_spec_template.md`
- `registries/APPFORGE_FEATURE_MANIFEST.json`
- `mcp/MCP_RESOURCE_MAP.json`
- `mcp/MCP_PROMPT_CATALOG.md`
- `mcp/MCP_TOOL_CATALOG.md`
- `validation/validate_all.py`
- `validation/validate_feature_manifest.py`
- `scripts/workspace-tools/collect_repo_status.py`
...
| --- | --- | --- |
| `mcp/interface/server/auth.py` | `http_authorization.py` | The file checks HTTP authorization headers, not general auth. |
| `mcp/interface/server/manifest_loader.py` | `appforge_manifest_loader.py` | It loads AppForger feature/resource manifests, not arbitrary manifests. |
...
| `mcp/INSTALL_AND_USE.md` | `MCP_INSTALL_AND_USE.md` | Clearer when linked outside the MCP folder. |
| `mcp/REMOTE_HOSTING_GUIDE.md` | `MCP_REMOTE_HOSTING_GUIDE.md` | Clearer when surfaced through search results or MCP resources. |
| `docs/generated-app/app-usage-templates/USER_OPERATOR_MANUAL_DO_NOT_LOAD.md` | `APP_USAGE_DOCS_OPERATOR_MANUAL_EXCLUDE_FROM_CONTEXT.md` | The current name says what not to do but not what the file is for. |
...
- `registries/SKILL_REGISTRY.md` when skill paths change
