...
Do not use unsupported options directly inside a project. Upgrade Appforger first, then use the new capability.
...
- `registries/project-control/stack-registry.md`
- `registries/project-control/connector-registry.md`
- `registries/project-control/mcp-registry.md`
- `registries/project-control/skill-registry.md`
