...
The user says the task is done, but Appforger cannot verify all required evidence.
...
The user intentionally closed the task despite missing evidence. Appforger must record the risk and recommended follow-up.
