...
If a local-only artifact becomes important, promote it through `PROMOTION_POLICY.md` and register it in `workflows/operations/artifact-imports/IMPORTED_ARTIFACT_REGISTRY.md` or the relevant registry.
