...
|---|---|---|---|
| `engine_static` | reusable engine logic | `appforge-engine/` | yes, engine repo only |
...
| `engine_upgrade` | modifications to AppForge itself | `appforge-engine/` | yes, engine repo |
