# AppForge Workspace Pointer

This file identifies how this local device connects to AppForge project-control and implementation repos.
...
```yaml
engine_local_path: ../appforge-engine
engine_remote_url:
engine_version:
```
