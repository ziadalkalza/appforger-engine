...
This folder defines how AppForge works when frontend, backend, design, QA, or project-control work happens on different devices or by different people.

AppForge does not require every repo to be local on one machine. It requires that every needed context source is either:
