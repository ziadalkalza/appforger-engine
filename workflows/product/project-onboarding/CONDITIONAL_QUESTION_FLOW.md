...
AppForge must ask follow-up questions based on previous answers.
...
- What should AppForge treat as current truth?
...
Ask tool consistency preference before model/provider preference. If the user chooses one-tool-family dependent work, AppForge must warn when they pick providers from different tool families for dependent tasks.
