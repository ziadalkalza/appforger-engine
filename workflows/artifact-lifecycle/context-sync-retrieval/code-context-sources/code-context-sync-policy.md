...
sync_modes:
  ...
  ci_generated_context:
    description: "CI workflow publishes summary/map artifacts for Appforger to import."

  agent_after_approval:
    description: "Authorized tool refreshes context after approved task execution."
```

Appforger v1 may provide templates and validators. It must not pretend to have a live autonomous runner unless an external tool/model is actually executing the scripts.
