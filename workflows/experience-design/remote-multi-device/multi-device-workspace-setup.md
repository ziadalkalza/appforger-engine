...
GitHub organization/project:
  appname-appforger-engine        # reusable engine; changes rarely
...
Each local workspace should include an `APPFORGER_WORKSPACE.md` file, generated from `WORKSPACE_POINTER_TEMPLATE.md`, that records local paths and remote URLs.
