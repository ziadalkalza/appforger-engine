...
- No auth.
- Managed auth through an approved backend app profile.
- Custom auth through an approved backend stack profile.
- Third-party auth provider through an active integration pack, or engine upgrade if unsupported.
