...
create table if not exists secret_metadata (
  ...
  value_stored_here boolean not null default false
);
...
-- Add project-specific Supabase RLS policies after reviewing TEAM_OPERATIONS_AUTH_AND_PERMISSION_MODEL.md.
