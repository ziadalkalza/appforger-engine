...
This layer lets AppForge coordinate multiple role-scoped workers without pretending that the file-based engine can launch autonomous agents by itself.
...
Key rules:
- AppForge is provider-agnostic, but brand-family consistency is preferred for dependent work.
