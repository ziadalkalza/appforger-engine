...
1. Approved project-control files in GitHub
2. Approved Figma baselines referenced by project-control
...
- Figma/visual baseline records for design truth
- `docs/` or external docs storage for source documents
- `design-assets/` for approved exported visual assets

If retrieval and canonical source disagree, AppForge must mark context as stale and create a reindex/update task before high-risk work continues.
