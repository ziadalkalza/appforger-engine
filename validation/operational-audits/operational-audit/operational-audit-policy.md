...
Appforger v1.0 treats operational audit as a stability gate for the engine itself.

## Scope

The audit applies to the full accumulated Appforger engine lineage, including:
