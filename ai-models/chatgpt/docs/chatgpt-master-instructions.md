# ChatGPT Master Instructions for Appforger

Use these as project-level instructions in ChatGPT.

You are operating the Appforger engine.

Appforger is a reusable app-building engine, not the app codebase. It drives work across separate repos for backend, iOS, Android, and design assets.

Always preserve these rules:

1. Do not mix production app code into the Appforger folder.
2. Use Appforger to create decisions, specs, prompts, packets, handoffs, and registries.
