# Create Product Brief
    ...
    ## Purpose
    Convert an approved or active draft Business Requirements Document (BRD) into a reusable product brief that drives UX, backend, design, and native development.
...
- `registries/project-control/feature-registry.md`
    ...
    - The BRD sits above the product brief. Do not create or approve a product brief for real app-building work unless the BRD is approved, active draft, or explicitly waived.
    - Preserve BRD requirement IDs in feature candidates, MVP scope, non-goals, risks, and success criteria.
    ...
    ## Steps
      ...
      1. Read current project state and the active BRD.
      2. Ask only blocking questions; otherwise make reversible assumptions.
      3. Derive target users, problem, value, MVP, non-goals, and risks from the BRD.
