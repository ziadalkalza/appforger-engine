...
Classify and close an Appforger task without confusing checkpoint progress with verified completion.
...
3. Check required evidence using `workflows/experience-design/task-completion-evidence/completion-evidence-matrix.md`.
