...
## Purpose
Create a GitHub Actions workflow from an approved job definition.
...
3. Identify required approval mode: local, source-control app review, hybrid, or future server.
