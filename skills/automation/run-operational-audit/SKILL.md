...
## Purpose
Audit the complete Appforger engine for structural and rule compatibility before a stable release or before using the engine on an important project.

## Inputs
- Appforger engine folder.
