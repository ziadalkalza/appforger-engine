# AppForge Active Rules

Generated from onboarding answers. Do not manually invent active rules without updating onboarding answers and `APPFORGE_PROJECT.yaml`.
