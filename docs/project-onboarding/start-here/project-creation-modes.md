...
- Appforger creates shared product specs, shared screen specs, shared API contracts, backend, and native implementation tasks.
...
Do not proceed past requirements until the app mode is selected and recorded in `APPFORGER_PROJECT_STATUS.md` and `DECISION_LOG.md`.

## Optional web modes

Appforger can also activate a Web Track when requested.
