...
5. Check `docs/getting-started/start-here/SETUP_AND_FIRST_RUN_GUIDE.md` and this documentation folder.
...
4. Check `runtime/platform/storage/README.md`.
...
2. Check `mcp/INSTALL_AND_USE.md`.
