...
- `docs/getting-started/start-here/SETUP_AND_FIRST_RUN_GUIDE.md`
- `docs/getting-started/start-here/ENV_AND_SECRETS_QUICKSTART.md`
...
- ask a model to read `docs/getting-started/start-here/START_HERE_FOR_AGENTS.md`;
...
- `docs/getting-started/start-here/START_HERE_FOR_AGENTS.md`
- `docs/getting-started/start-here/AGENT_BOOTSTRAP_PROMPTS.md`
...
- `templates/engine/project-control-template/runtime/`
...
- `templates/engine/project-control-template/code_sources/`
...
- `templates/engine/project-control-template/code_sources/scripts/`
...
- `workflows/operations/source-pipelines/`
- `templates/engine/project-control-template/pipelines/`
...
- `templates/engine/project-control-template/doc_sources/`
...
- `templates/engine/project-control-template/git_providers/`
...
- `workflows/operations/project-adoption-git-boundaries/`
- `templates/engine/project-control-template/git_boundaries/`
...
- `validation/audits/operational-audit/FEATURE_STATUS_AUDIT.md`
