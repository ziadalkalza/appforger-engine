...
Start here:
- `docs/getting-started/start-here/START_HERE_FOR_AGENTS.md` for first-time agent setup.
- `docs/getting-started/start-here/SETUP_AND_FIRST_RUN_GUIDE.md` for manual setup.
...
```text
appforge-engine/templates/engine/
