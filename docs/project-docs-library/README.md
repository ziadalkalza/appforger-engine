...
Documents live in `docs/` or an approved external docs storage provider. Appforger indexes summaries/extractions and always points retrieval results back to original sources.
