...
Do not paste third-party design systems directly into `workflows/experience-design/design-workflow/global_design_system.md`. Instead, register them in `registries/IMPORTED_DESIGN_SYSTEM_REGISTRY.md` and summarize how they should influence the current project.
...
Use `skills/design/generic/import_design_system/SKILL.md` for the full workflow.
