...
integrations/design/generic/design-system-imports/MOBILE_NATIVE_MAPPING_TEMPLATE.md
validation/domains/visual-qa-runtime/VISUAL_DIFF_REPORT_TEMPLATE.md
workflows/experience-design/design-workflow/project_design_override_rules.md, if the user approves project-specific use
```
