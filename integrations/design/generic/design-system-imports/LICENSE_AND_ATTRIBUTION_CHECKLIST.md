...
Complete this before importing an external design system into an AppForge project.
...
- Do not store paid, private, or confidential design systems in reusable AppForge core unless the user explicitly owns the rights and wants that.
