...
Before building an integration pack, Appforger must ask only the questions needed to avoid unsafe or wrong implementation. Batch questions to save tokens.
...
6. Should Appforger create a reusable engine integration pack or only a project-specific runbook?
