...
Define how AppForge decides whether context should be loaded from local folders, remote GitHub repositories, connector/MCP access, or imported artifact packets.
...
| Artifact packet | A source was exported/imported into AppForge | Valid if approved/current |
