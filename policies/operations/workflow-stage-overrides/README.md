...
AppForge workflows are recommended paths, not rigid waterfalls.

A project may skip, substitute, reorder, import, or draft stages when that better fits the project, team, or available artifacts. The flexibility is allowed only when AppForge records the reason, runs impact analysis, preserves source-of-truth boundaries, and keeps non-negotiable rules active.
