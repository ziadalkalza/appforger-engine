...
| create_ux_flows | Define flows | ux_flow | design_skills/create_ux_flows |
| create_figma_prompt | Prepare Figma work | figma_design | design_skills/create_figma_prompt |
| import_figma_baseline | Bring Figma back | figma_design | ARTIFACT_IMPORTS + BASELINES |
| select_backend_stack | Choose backend | backend | backend_skills/select_backend_stack |
| build_supabase_backend | Supabase backend | backend | Codex backend packet |
| build_fastapi_backend | FastAPI/Postgres backend | backend | Codex backend packet |
| create_api_contract | API baseline | api_contract | API packet |
| implement_ios_screen | SwiftUI implementation | native_frontend | Codex iOS packet |
| implement_android_screen | Compose implementation | native_frontend | Codex Android packet |
...
| import_design_system | Add design rules | design | import_design_system skill |
