...
AppForge still keeps the same engine boundary: production web code belongs in a sibling repo such as `web/` or `web-app/`, not inside the AppForge engine folder.
