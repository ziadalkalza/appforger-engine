...
The initializer copies `ENGINE_TEMPLATES/project-control-template/` into the generated `project-control/` folder and creates shared folders such as `docs/`, `design-assets/`, `exports/`, and `local-only/`.
