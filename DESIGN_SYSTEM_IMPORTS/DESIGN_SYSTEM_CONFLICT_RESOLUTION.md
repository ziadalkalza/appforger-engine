...
Use this when AppForge, a project design system, an imported design system, Figma, and platform defaults disagree.

## Default priority before Figma approval
...
## Default priority after Figma approval

```text
1. Accessibility, security, privacy, performance, and platform constraints
2. Latest approved Figma/design baseline
...
- Figma can override visual rules only after approval.
