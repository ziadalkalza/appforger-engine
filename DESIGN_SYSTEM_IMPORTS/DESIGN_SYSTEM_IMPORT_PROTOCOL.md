...
This protocol controls how external design systems enter AppForge.

## Goal

Let the user improve AppForge's design quality by importing strong external design guidance while preserving:

- engine reusability
- legal/license clarity
- project-specific control
- Figma approval as the implementation baseline
...
- Codex/ChatGPT design skills
- brand guideline PDFs or docs
- Figma UI kits
- exported Figma tokens
- design token JSON
- component specs
...
- force production code into the AppForge engine folder
- bypass Figma approval
- bypass visual QA
