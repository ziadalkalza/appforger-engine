...
The Team Operations Backend is a queryable operational mirror/control layer. When it disagrees with project-control, AppForge must flag a sync conflict and reconcile before using the backend state as current.
