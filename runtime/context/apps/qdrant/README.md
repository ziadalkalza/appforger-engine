...
Qdrant is used as AppForge's semantic memory layer. It indexes summaries and approved project artifacts so AppForge can retrieve relevant context quickly.
