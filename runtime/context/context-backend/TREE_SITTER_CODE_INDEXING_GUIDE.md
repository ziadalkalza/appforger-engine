...
When raw or structured code indexing is explicitly enabled, AppForge should prefer structure-aware parsing such as Tree-sitter over naive text chunking.
