...
- `PROJECT_ONBOARDING_AND_INITIALIZATION/`
- `START_HERE/SETUP_AND_FIRST_RUN_GUIDE.md`
- `START_HERE/ENV_AND_SECRETS_QUICKSTART.md`
...
- `PROVIDER_EXECUTION_LAYER/`
- `PROVIDER_ROUTING_AND_PACKET_TARGETS/`
...
- ask a model to read `START_HERE/START_HERE_FOR_AGENTS.md`;
...
- `START_HERE/START_HERE_FOR_AGENTS.md`
- `START_HERE/AGENT_BOOTSTRAP_PROMPTS.md`
...
- `PARALLEL_WORK_AND_SUB_AGENT_ORCHESTRATION/`
- `AGENTS/`
- `TEAM_COLLABORATION/`
...
- `ENGINE_TEMPLATES/project-control-template/runtime/`
...
- `CONTEXT_BACKEND/`
- `CONTEXT_SYNC_AND_RETRIEVAL/`
- `SKILLS/context_backend_skills/`
...
- `CONTEXT_SYNC_AND_RETRIEVAL/code_context_sources/`
- `ENGINE_TEMPLATES/project-control-template/code_sources/`
- `SKILLS/code_context_skills/`
- `SKILLS/workflow_skills/import_existing_backend/`
- `SKILLS/workflow_skills/import_existing_frontend/`
...
- `ENGINE_TEMPLATES/project-control-template/code_sources/scripts/`
- `RUNTIME_INFRASTRUCTURE/graph/`
- `SOURCE_PIPELINES/`
...
- `SOURCE_PIPELINES/`
- `ENGINE_TEMPLATES/project-control-template/pipelines/`
- `SKILLS/source_pipeline_skills/`
...
- `DOC_SOURCE_INTEGRATIONS/`
- `ENGINE_TEMPLATES/project-control-template/doc_sources/`
- `SKILLS/doc_source_skills/`
...
- `GIT_PROVIDER_INTEGRATIONS/`
- `SKILLS/git_provider_skills/`
- `ENGINE_TEMPLATES/project-control-template/git_providers/`
...
- append AppForger-managed `.gitignore` blocks.
...
- `PROJECT_ADOPTION_AND_GIT_BOUNDARIES/`
- `SKILLS/project_adoption_skills/`
...
- `WORKSPACE_AND_ARTIFACT_LIFECYCLE/`
- `SKILLS/cleanup_skills/`
...
- keep `appforge-engine/` out of app repos;
...
- `PROJECT_ADOPTION_AND_GIT_BOUNDARIES/`
- `ENGINE_TEMPLATES/project-control-template/git_boundaries/`
...
- `BACKEND/`
- `API_CONTRACT_AND_BACKEND_FIRST/`
...
- `USER_STORIES/`
- `TRELLO_INTEGRATION/`
- `PROJECT_MANAGER_AND_ORCHESTRATION/`
...
- `RELEASE/`
- `RELEASE_MANAGEMENT/`
- `RELEASE_EVIDENCE_AND_APPROVALS/`
- `MOBILE_STORE_RELEASE/`
...
- `FLEXIBLE_WORKFLOW_AND_STAGE_OVERRIDES/`
- `PROJECT_ENGINE_OVERRIDES/`
...
- `OPERATIONAL_AUDIT/FEATURE_STATUS_AUDIT.md`
