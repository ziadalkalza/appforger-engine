...
```text
Read appforge-engine/START_HERE/START_HERE_FOR_AGENTS.md and set up AppForger for this project.
```
...
```bash
python appforge-engine/NEW_APP_INITIALIZER/setup_appforge_project.py \
  --target . \
  --name "My Product" \
