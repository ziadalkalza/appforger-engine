...
class ToolProvider:
    ...
    def call(self, name: str, args: dict | None = None) -> dict:
        ...
        if name == "create_setup_plan":
            ...
            cmd = f"python appforge-engine/NEW_APP_INITIALIZER/setup_appforge_project.py --target . --name \"{project}\""
            if adapter != "ask":
        ...
        if name == "create_adoption_plan":
            cmd = "python appforge-engine/PROJECT_ADOPTION_AND_GIT_BOUNDARIES/scripts/appforge_adopt.py --target . scan"
        ...
        if name == "create_cleanup_plan":
            ...
            cmd = f"python appforge-engine/WORKSPACE_AND_ARTIFACT_LIFECYCLE/scripts/appforge_clean.py --target . --mode {mode}"
            risk = classify_action(cmd)
            risk["risk"] = "high"
            risk["requires_user_approval"] = True
        ...
        if name == "create_integration_strategy_plan":
            ...
            return {
                ...
                "decision_packet_template": "ENGINE_TEMPLATES/project-control-template/integrations/integration-decision-packet.template.md",
                "next_steps": [
        ...
        if name == "create_feature_request_issue_plan":
            ...
            return {
                ...
                "issue_template": "APPFORGE_MCP_SERVER/FEATURE_REQUESTS_AND_ISSUES.md",
