...
PROMPTS = {
    ...
    "setup_appforge_project": """Use AppForger to set up a project. Inspect whether this is new/existing/ongoing. Use the setup command reference. Do not generate provider adapters unless requested. Tell the user to fill local-only/.env.local.""",
